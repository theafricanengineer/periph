...
// Write accepts a stream of raw RGB pixels and sends it as NRZ encoded stream.
...
// 400000.
func New(p gpio.PinOut, numLights, speed int) (*Dev, error) {
	...
	return &Dev{
		...
		b: stream.Bits{
			...
			Bits: make(gpio.Bits, numLights*3*3),
		},
	}, nil
}
